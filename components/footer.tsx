        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <nav className="flex md:text-[22px]  flex-col lg:flex-row text-[17px] leading-[28px] mr-10 items-center gap-6">
            ...
            <div className="relative isolate">
              <Button
                variant="default"
                className="bg-[#FFCA0D] relative text-[22px] leading-[28px] hover:bg-yellow-500 rounded-[6px] lg:px-[30px] py-[10px] text-black font-bold"
              >
                Buy $B
              </Button>
              ...
              <Button
                variant="default"
                className="bg-[#F9E7CD] pointer-events-none absolute -left-1 top-1 -z-10 text-[22px] leading-[28px] rounded-[6px] lg:px-[30px] py-[10px] text-black font-bold"
              >
                Buy $B
              </Button>
            </div>
